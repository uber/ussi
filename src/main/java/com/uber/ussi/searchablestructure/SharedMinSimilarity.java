 ...
 *
 * <p>A division that has filled its heap holds as many rows as the answer keeps, each scoring at least
 ...
 * division's minimum similarity is therefore sound for every division, and this holds the highest any of
 * them has published.
 *
 * <p>A division whose heap is not yet full has proved nothing and publishes nothing.
 *
 * <p>This only rises, and it is one value rather than a structure, so it needs no lock. Divisions keep
