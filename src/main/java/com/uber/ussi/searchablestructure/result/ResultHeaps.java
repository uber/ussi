...
/**
 * Builds the bounded heap of the rows a search keeps, and derives the similarity a row must beat
 * to enter it.
 *
 ...
 */
public final class ResultHeaps {
  private ResultHeaps() {}

  public static BoundedSizeMaxHeap<RowNumAndSimilarity> newTopResults(int maxResults) {
